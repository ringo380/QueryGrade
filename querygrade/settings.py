...
ML_AUTO_RETRAIN = os.environ.get("ML_AUTO_RETRAIN", "True").lower() in (
    "true",
    "1",
    "yes",
    "on",
)
ML_FEEDBACK_COLLECTION = os.environ.get("ML_FEEDBACK_COLLECTION", "True").lower() in (
    "true",
    "1",
    "yes",
    "on",
...
RATELIMIT_ENABLE = os.environ.get("RATELIMIT_ENABLE", "False").lower() in (
    "true",
    "1",
    "yes",
    "on",
