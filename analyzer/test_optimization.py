...
class QueryOptimizationTestCase(TransactionTestCase):
    ...
    def test_specific_optimization_patterns(self):
        ...
        self.assertIn('Replaced SELECT * with specific columns', result['optimizations_applied'])
        ...
        self.assertIn('Removed functions from WHERE clause columns', result['optimizations_applied'])
