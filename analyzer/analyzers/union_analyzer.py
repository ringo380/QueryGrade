...
class UnionAnalyzer(BaseAnalyzer):
    ...
    def _check_union_vs_union_all(self, sql_text: str, context: AnalysisContext) -> None:
    ...
    def _check_union_alternatives(self, sql_text: str, context: AnalysisContext) -> None:
    ...
    def _check_union_distinct_redundancy(self, sql_text: str, context: AnalysisContext) -> None:
        """Check for DISTINCT with UNION."""
        if 'DISTINCT' in sql_text and 'UNION' in sql_text and 'UNION ALL' not in sql_text:
            context.issues.append({
