...
class UnionAnalyzerTests(TestCase):
    ...
    def test_union_all_no_issue(self):
        ...
        union_issues = [i for i in analysis.issues_found if i['type'] == 'UNION_WITHOUT_ALL']
    ...
    def test_union_to_or_recommendation(self):
        ...
        recommendations = [r for r in analysis.recommendations if r['type'] == 'UNION_TO_OR']
    ...
    def test_no_union_issues_for_simple_query(self):
        ...
        union_issues = [i for i in analysis.issues_found if 'union' in i.get('type', '').lower()]
        self.assertEqual(len(union_issues), 0)
...
class WindowFunctionAnalyzerTests(TestCase):
    ...
    def test_window_without_partition(self):
        ...
        issues = [i for i in analysis.issues_found if i['type'] == 'WINDOW_NO_PARTITION']
        self.assertTrue(len(issues) > 0)
        self.assertEqual(issues[0]['severity'], 'medium')
    ...
    def test_row_number_without_order(self):
        ...
        issues = [i for i in analysis.issues_found if i['type'] == 'ROW_NUMBER_NO_ORDER']
        self.assertTrue(len(issues) > 0)
    ...
    def test_named_window_recommendation(self):
        ...
        recommendations = [r for r in analysis.recommendations if r['type'] == 'USE_NAMED_WINDOW']
        self.assertTrue(len(recommendations) > 0)
    ...
    def test_partition_by_index_recommendation(self):
        ...
        recommendations = [r for r in analysis.recommendations if r['type'] == 'INDEX_PARTITION_COLUMNS']
        self.assertTrue(len(recommendations) > 0)
    ...
    def test_function_in_partition_by(self):
        ...
        issues = [i for i in analysis.issues_found if i['type'] == 'FUNCTION_IN_PARTITION_BY']
        self.assertTrue(len(issues) > 0)
    ...
    def test_no_window_issues_for_simple_query(self):
        ...
        window_issues = [i for i in analysis.issues_found if 'window' in i.get('type', '').lower()]
...
class CaseStatementAnalyzerTests(TestCase):
    ...
    def test_complex_case_nesting(self):
        ...
        issues = [i for i in analysis.issues_found if i['type'] == 'COMPLEX_CASE_NESTING']
    ...
    def test_coalesce_recommendation(self):
        ...
        recommendations = [r for r in analysis.recommendations if r['type'] == 'USE_COALESCE']
        self.assertTrue(len(recommendations) > 0)
    ...
    def test_no_case_issues_for_simple_query(self):
        ...
        case_issues = [i for i in analysis.issues_found if 'case' in i.get('type', '').lower()]
...
class WildcardAnalyzerTests(TestCase):
    ...
    def test_like_both_wildcards(self):
        ...
        issues = [i for i in analysis.issues_found if i['type'] == 'LIKE_BOTH_WILDCARDS']
        self.assertTrue(len(issues) > 0)
        self.assertEqual(issues[0]['severity'], 'high')
    ...
    def test_like_leading_wildcard(self):
        ...
        leading_issues = [i for i in analysis.issues_found if 'LEADING_WILDCARD' in i['type']]
    ...
    def test_like_trailing_wildcard_ok(self):
        ...
        critical_like_issues = [i for i in analysis.issues_found
    ...
    def test_no_like_issues_for_simple_query(self):
        ...
        like_issues = [i for i in analysis.issues_found if 'like' in i.get('type', '').lower()]
