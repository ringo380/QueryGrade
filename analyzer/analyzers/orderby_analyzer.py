...
class OrderByAnalyzer(BaseAnalyzer):
    ...
    def _check_orderby_without_limit(self, sql_text: str, context: AnalysisContext) -> None:
        """Check for ORDER BY without LIMIT - sorts entire result set."""
        has_order_by = 'ORDER BY' in sql_text
        has_limit = 'LIMIT' in sql_text or 'TOP' in sql_text or 'FETCH FIRST' in sql_text
    ...
    def _check_orderby_with_functions(self, sql_text: str, context: AnalysisContext) -> None:
    ...
    def _check_orderby_expression(self, sql_text: str, context: AnalysisContext) -> None:
    ...
    def _check_multi_column_ordering(self, sql_text: str, context: AnalysisContext) -> None:
    ...
    def _check_orderby_with_distinct(self, sql_text: str, context: AnalysisContext) -> None:
    ...
    def _check_orderby_in_subquery(self, sql_text: str, context: AnalysisContext) -> None:
