...
class IndexingAnalyzer(BaseAnalyzer):
    ...
    def _check_function_on_columns(self, sql_text: str, context: AnalysisContext) -> None:
    ...
    def _check_composite_index_opportunities(self, sql_text: str, context: AnalysisContext) -> None:
