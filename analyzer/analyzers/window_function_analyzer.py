...
class WindowFunctionAnalyzer(BaseAnalyzer):
    ...
    def _check_window_without_partition(
    ...
    def _check_row_number_without_order(
        self, sql_text: str, context: AnalysisContext
    ) -> None:
    ...
    def _check_redundant_window_definitions(
        self, sql_text: str, context: AnalysisContext
    ) -> None:
    ...
    def _check_window_vs_aggregate(
        self, sql_text: str, context: AnalysisContext
    ) -> None:
        ...
        has_window_aggregate = (
            any(func in sql_text for func in ["SUM(", "AVG(", "COUNT(", "MAX(", "MIN("])
    ...
    def _check_named_window_opportunity(
        self, sql_text: str, context: AnalysisContext
    ) -> None:
    ...
    def _check_partition_by_efficiency(
        self, sql_text: str, context: AnalysisContext
    ) -> None:
    ...
    def _check_window_function_types(
        self, sql_text: str, context: AnalysisContext
    ) -> None:
    ...
    def _check_window_with_distinct(
        self, sql_text: str, context: AnalysisContext
    ) -> None:
