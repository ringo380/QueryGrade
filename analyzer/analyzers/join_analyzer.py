...
class JoinAnalyzer(BaseAnalyzer):
    ...
    def _check_cartesian_products(self, sql_text: str, context: AnalysisContext) -> None:
    ...
    def _check_join_conditions(self, sql_text: str, context: AnalysisContext) -> None:
        ...
        for join_match in joins:
            ...
            next_clause_pattern = r'\b(WHERE|GROUP\s+BY|ORDER\s+BY|HAVING|LIMIT|UNION|JOIN|;)\b'
