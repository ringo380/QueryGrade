...
from analyzer.performance import query_cache, memory_optimizer
...
class Command(BaseCommand):
    ...
    def warm_cache(self):
        ...
        try:
            ...
            ).select_related('analysis').order_by('-created_at')[:100]
                ...
                if 'sqlite' in settings.DATABASES['default']['ENGINE']:
                    ...
                    for optimization in optimizations:
                        try:
                            ...
                            self.stdout.write(
                                self.style.WARNING(f'Optimization failed: {optimization}: {e}')
                            )
        ...
        try:
            ...
            try:
                for filename in os.listdir(temp_dir):
                    if filename.startswith('secure_upload_') and filename.endswith('.log'):
