...
class QueryGradeForm(forms.Form):
    ...
    database_version = forms.CharField(
        ...
        widget=forms.TextInput(
            attrs={"class": "form-control", "placeholder": "e.g., 8.0, 13.4, etc."}
        ),
    ...
    def clean_sql_query(self):
        ...
        if sql_query:
            ...
            sql_query = "\n".join(
                line.strip() for line in sql_query.split("\n") if line.strip()
            )
        return sql_query
...
class QueryCompareForm(forms.Form):
    ...
    def clean_query_3(self):
        ...
        if query_3 and query_3.strip():
            ...
            # Remove excessive whitespace while preserving structure
            query_3 = "\n".join(
                line.strip() for line in query_3.split("\n") if line.strip()
            )
        return query_3
    ...
    def clean_query_1(self):
        ...
        if query_1:
            query_1 = "\n".join(
                line.strip() for line in query_1.split("\n") if line.strip()
            )
        return query_1
    ...
    def clean_query_2(self):
        ...
        if query_2:
            query_2 = "\n".join(
                line.strip() for line in query_2.split("\n") if line.strip()
            )
        return query_2
