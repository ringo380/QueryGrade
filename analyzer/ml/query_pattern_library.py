...
class QueryPatternLibrary:
    ...
    def _initialize_default_patterns(self):
        ...
        self.add_pattern(QueryPattern(
            ...
            use_cases=["Combining related data", "Fetching data from multiple tables"],
        ...
        self.add_pattern(QueryPattern(
            ...
            use_cases=["Optional relationships", "Including records without matches"],
        ...
        self.add_pattern(QueryPattern(
            ...
            use_cases=["Filtering aggregated results", "Finding groups meeting criteria"],
    ...
    def suggest_improvements(self, query: str) -> List[Dict[str, Any]]:
        ...
        for pattern in matching_patterns:
            if pattern.quality in [PatternQuality.SUBOPTIMAL, PatternQuality.ANTI_PATTERN]:
