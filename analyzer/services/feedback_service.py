...
class FeedbackService:
    ...
    def submit_detailed_feedback(self, submission: FeedbackSubmission) -> FeedbackResult:
        """
    ...
    def get_feedback_for_analysis(
        ...
        try:
            ...
            return QueryFeedback.objects.filter(
                user_history=user_history
            ).first()
    ...
    def _update_feedback(
        ...
        feedback.accuracy_rating = submission.accuracy_rating or feedback.accuracy_rating
        feedback.usefulness_rating = submission.usefulness_rating or feedback.usefulness_rating
